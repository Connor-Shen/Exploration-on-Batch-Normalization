...
from RESNET_activation import ResNet18
...
labels = ["ReLU", "Sigmoid", 'LeakyReLU', 'Tanh', 'Softplus']
...
if not os.path.isdir('activation'):
    os.mkdir('activation')
plt.savefig(f'./activation/figure.png')
