...
optim_func = [optim.SGD(net.parameters(), lr=learning_rate, momentum=0.9, weight_decay=5e-4), optim.Adam(net.parameters(), lr=learning_rate, weight_decay=5e-4), optim.RMSprop(net.parameters(), lr=learning_rate, weight_decay=5e-4), optim.Adagrad(net.parameters(), lr=learning_rate, weight_decay=5e-4), optim.Adadelta(net.parameters(), lr=learning_rate, weight_decay=5e-4)]

for optims in optim_func:
...
if not os.path.isdir('optim'):
    os.mkdir('optim')
plt.savefig(f'./optim/figure.png')
