...
net_18 = ResNet18().to(device)
net_50 = ResNet50().to(device)
net_101 = ResNet101().to(device)

net_list = [net_18, net_50, net_101]
...
if not os.path.isdir('multi_resnet'):
    os.mkdir('multi_resnet')
plt.savefig(f'./multi_resnet/figure.png')
